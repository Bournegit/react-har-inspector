...
var themeAcceptor = function themeAcceptor(WrappedComponent) {
  var ThemeAcceptor = function ThemeAcceptor(_ref) {
    ...
    return /*#__PURE__*/React__default.createElement(ThemeContext.Provider, {
      value: themeStyles
    }, /*#__PURE__*/React__default.createElement(WrappedComponent, restProps));
  };
...
var TreeNode = React.memo(function (props) {
  props = _objectSpread$1({
    ...
    nodeRenderer: function nodeRenderer(_ref2) {
      var name = _ref2.name;
      return /*#__PURE__*/React__default.createElement("span", null, name);
    },
  ...
  return /*#__PURE__*/React__default.createElement("li", {
    ...
    onClick: onClick
  }, shouldShowArrow || React.Children.count(children) > 0 ? /*#__PURE__*/React__default.createElement(Arrow, {
    expanded: expanded,
    styles: styles.treeNodeArrow
  }) : shouldShowPlaceholder && /*#__PURE__*/React__default.createElement("span", {
    style: styles.treeNodePlaceholder
  }, "\xA0"), /*#__PURE__*/React__default.createElement(NodeRenderer, props)), /*#__PURE__*/React__default.createElement("ol", {
    role: "group",
...
var ConnectedTreeNode = React.memo(function (props) {
  ...
  return /*#__PURE__*/React__default.createElement(TreeNode, _extends_1({
    expanded: expanded,
  ...
  expanded ? toConsumableArray(dataIterator(data)).map(function (_ref) {
    ...
    return /*#__PURE__*/React__default.createElement(ConnectedTreeNode, _extends_1({
      name: name,
      data: data,
      depth: depth + 1,
...
var TreeView = React.memo(function (_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(ExpandedPathsContext.Provider, {
    value: stateAndSetter
  }, /*#__PURE__*/React__default.createElement("ol", {
    role: "tree",
    style: styles.treeViewOutline
  }, /*#__PURE__*/React__default.createElement(ConnectedTreeNode, {
    name: name,
    data: data,
    dataIterator: dataIterator,
    depth: 0,
  ...
  switch (_typeof_1(object)) {
    ...
    case 'object':
      ...
      if (object instanceof Date) {
        return /*#__PURE__*/React__default.createElement("span", null, object.toString());
      }
      ...
      if (Array.isArray(object)) {
        return /*#__PURE__*/React__default.createElement("span", null, "Array(".concat(object.length, ")"));
      }

      if (!object.constructor) {
        return /*#__PURE__*/React__default.createElement("span", null, "Object");
      }

      if (typeof object.constructor.isBuffer === 'function' && object.constructor.isBuffer(object)) {
        return /*#__PURE__*/React__default.createElement("span", null, "Buffer[".concat(object.length, "]"));
      }

      return /*#__PURE__*/React__default.createElement("span", null, object.constructor.name);

    case 'function':
      return /*#__PURE__*/React__default.createElement("span", null, /*#__PURE__*/React__default.createElement("span", {
        style: mkStyle('objectValueFunctionPrefix')
      }, "\u0192\xA0"), /*#__PURE__*/React__default.createElement("span", {
...
var ObjectPreview = function ObjectPreview(_ref) {
  ...
  if (_typeof_1(object) !== 'object' || object === null || object instanceof Date || object instanceof RegExp) {
    return /*#__PURE__*/React__default.createElement(ObjectValue, {
      object: object
    });
  }
  ...
  if (Array.isArray(object)) {
    ...
    if (object.length > maxProperties) {
      previewArray.push( /*#__PURE__*/React__default.createElement("span", {
        key: "ellipsis"
      }, "\u2026"));
    }
    ...
    }, arrayLength === 0 ? "" : "(".concat(arrayLength, ")\xA0")), /*#__PURE__*/React__default.createElement("span", {
    ...
    for (var propertyName in object) {
      ...
      if (hasOwnProperty.call(object, propertyName)) {
        ...
        if (propertyNodes.length === _maxProperties - 1 && Object.keys(object).length > _maxProperties) {
          ellipsis = /*#__PURE__*/React__default.createElement("span", {
            key: 'ellipsis'
          }, "\u2026");
        }

        propertyNodes.push( /*#__PURE__*/React__default.createElement("span", {
          key: propertyName
        }, /*#__PURE__*/React__default.createElement(ObjectName, {
          name: propertyName || "\"\""
        }), ":\xA0", /*#__PURE__*/React__default.createElement(ObjectValue, {
    ...
    return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("span", {
      style: styles.objectDescription
    }, objectConstructorName === 'Object' ? '' : "".concat(objectConstructorName, " ")), /*#__PURE__*/React__default.createElement("span", {
      style: styles.preview
...
var ObjectRootLabel = function ObjectRootLabel(_ref) {
  ...
  if (typeof name === 'string') {
    return /*#__PURE__*/React__default.createElement("span", null, /*#__PURE__*/React__default.createElement(ObjectName, {
      name: name
    }), /*#__PURE__*/React__default.createElement("span", null, ": "), /*#__PURE__*/React__default.createElement(ObjectPreview, {
      data: data
    }));
  } else {
    return /*#__PURE__*/React__default.createElement(ObjectPreview, {
      data: data
    });
  }
};
...
var ObjectLabel = function ObjectLabel(_ref) {
  ...
  var object = data;
  return /*#__PURE__*/React__default.createElement("span", null, typeof name === 'string' ? /*#__PURE__*/React__default.createElement(ObjectName, {
    name: name,
    dimmed: isNonenumerable
  }) : /*#__PURE__*/React__default.createElement(ObjectPreview, {
    data: name
  }), /*#__PURE__*/React__default.createElement("span", null, ": "), /*#__PURE__*/React__default.createElement(ObjectValue, {
    object: object
  }));
};
...
var defaultNodeRenderer = function defaultNodeRenderer(_ref) {
  ...
  return depth === 0 ? /*#__PURE__*/React__default.createElement(ObjectRootLabel, {
    name: name,
    data: data
  }) : /*#__PURE__*/React__default.createElement(ObjectLabel, {
    name: name,
    data: data,
...
var ObjectInspector = function ObjectInspector(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(TreeView, _extends_1({
...
var DataContainer = function DataContainer(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    style: styles.table
  }, /*#__PURE__*/React__default.createElement("colgroup", null), /*#__PURE__*/React__default.createElement("tbody", null, rows.map(function (row, i) {
    return /*#__PURE__*/React__default.createElement("tr", {
      ...
      if (_typeof_1(rowData) === 'object' && rowData !== null && hasOwnProperty.call(rowData, column)) {
        ...
        }, /*#__PURE__*/React__default.createElement(ObjectValue, {
...
var TH = function TH(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement("th", _extends_1({}, thProps, {
    ...
    style: styles.div
  }, children), sorted && /*#__PURE__*/React__default.createElement(SortIconContainer, null, /*#__PURE__*/React__default.createElement(SortIcon, {
...
var TableInspector = function TableInspector(_ref) {
  ...
  }), /*#__PURE__*/React__default.createElement(DataContainer, {
    rows: rowHeaders,
    columns: colHeaders,
    rowsData: rowsData
  }));
  ...
  return /*#__PURE__*/React__default.createElement("span", {
    ...
    if (attributes) {
      ...
      for (var i = 0; i < attributes.length; i++) {
        ...
        attributeNodes.push( /*#__PURE__*/React__default.createElement("span", {
          key: i
        }, ' ', /*#__PURE__*/React__default.createElement("span", {
          style: styles.htmlAttributeName
        }, attribute.name), '="', /*#__PURE__*/React__default.createElement("span", {
...
var DOMNodePreview = function DOMNodePreview(_ref3) {
  ...
  if (isCloseTag) {
    return /*#__PURE__*/React__default.createElement(CloseTag, {
  ...
  switch (data.nodeType) {
    case Node.ELEMENT_NODE:
      return /*#__PURE__*/React__default.createElement("span", null, /*#__PURE__*/React__default.createElement(OpenTag, {
        tagName: data.tagName,
        attributes: data.attributes,
        styles: styles.htmlOpenTag
      }), shouldInline(data) ? data.textContent : !expanded && '…', !expanded && /*#__PURE__*/React__default.createElement(CloseTag, {
        tagName: data.tagName,
        styles: styles.htmlCloseTag
      }));

    case Node.TEXT_NODE:
      return /*#__PURE__*/React__default.createElement("span", null, data.textContent);

    case Node.CDATA_SECTION_NODE:
      return /*#__PURE__*/React__default.createElement("span", null, '<![CDATA[' + data.textContent + ']]>');
    ...
    case Node.PROCESSING_INSTRUCTION_NODE:
      return /*#__PURE__*/React__default.createElement("span", null, data.nodeName);
    ...
    default:
      return /*#__PURE__*/React__default.createElement("span", null, nameByNodeType[data.nodeType]);
  }
};
...
var Inspector = function Inspector(_ref) {
  ...
  if (table) {
    return /*#__PURE__*/React__default.createElement(TableInspector$1, _extends_1({
      data: data
    }, rest));
  }

  if (isDOM(data)) return /*#__PURE__*/React__default.createElement(DOMInspector$1, _extends_1({
    data: data
  }, rest));
  return /*#__PURE__*/React__default.createElement(ObjectInspector$1, _extends_1({
    data: data
  }, rest));
};
