...
var TreeNode = react_7(function (props) {
  ...
  return /*#__PURE__*/react.createElement("li", {
    ...
    onClick: onClick
  }, shouldShowArrow || react_8.count(children) > 0 ? /*#__PURE__*/react.createElement(Arrow, {
    expanded: expanded,
    styles: styles.treeNodeArrow
  }) : shouldShowPlaceholder && /*#__PURE__*/react.createElement("span", {
    style: styles.treeNodePlaceholder
  }, "\xA0"), /*#__PURE__*/react.createElement(NodeRenderer, props)), /*#__PURE__*/react.createElement("ol", {
    role: "group",
...
var ConnectedTreeNode = react_7(function (props) {
  ...
  return /*#__PURE__*/react.createElement(TreeNode, _extends_1({
    expanded: expanded,
  ...
  expanded ? toConsumableArray(dataIterator(data)).map(function (_ref) {
    ...
    return /*#__PURE__*/react.createElement(ConnectedTreeNode, _extends_1({
      name: name,
      data: data,
      depth: depth + 1,
  ...
  switch (_typeof_1(object)) {
    ...
    case 'object':
      ...
      if (Array.isArray(object)) {
        return /*#__PURE__*/react.createElement("span", null, "Array(".concat(object.length, ")"));
      }
      ...
      if (typeof object.constructor.isBuffer === 'function' && object.constructor.isBuffer(object)) {
        return /*#__PURE__*/react.createElement("span", null, "Buffer[".concat(object.length, "]"));
      }
    ...
    case 'function':
      ...
      }, "\u0192\xA0"), /*#__PURE__*/react.createElement("span", {
...
var ObjectPreview = function ObjectPreview(_ref) {
  ...
  if (Array.isArray(object)) {
    ...
    }, arrayLength === 0 ? "" : "(".concat(arrayLength, ")\xA0")), /*#__PURE__*/react.createElement("span", {
    ...
    for (var propertyName in object) {
      ...
      if (hasOwnProperty$1.call(object, propertyName)) {
        ...
        propertyNodes.push( /*#__PURE__*/react.createElement("span", {
          ...
          name: propertyName || "\"\""
        }), ":\xA0", /*#__PURE__*/react.createElement(ObjectValue, {
    ...
    return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("span", {
      style: styles.objectDescription
    }, objectConstructorName === 'Object' ? '' : "".concat(objectConstructorName, " ")), /*#__PURE__*/react.createElement("span", {
      style: styles.preview
...
var defaultNodeRenderer = function defaultNodeRenderer(_ref) {
  ...
  return depth === 0 ? /*#__PURE__*/react.createElement(ObjectRootLabel, {
    name: name,
    data: data
...
var ObjectInspector = function ObjectInspector(_ref2) {
  ...
  return /*#__PURE__*/react.createElement(TreeView, _extends_1({
...
var DataContainer = function DataContainer(_ref) {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    style: styles.table
  }, /*#__PURE__*/react.createElement("colgroup", null), /*#__PURE__*/react.createElement("tbody", null, rows.map(function (row, i) {
...
var TH = function TH(_ref2) {
  ...
  return /*#__PURE__*/react.createElement("th", _extends_1({}, thProps, {
    ...
    style: styles.div
  }, children), sorted && /*#__PURE__*/react.createElement(SortIconContainer, null, /*#__PURE__*/react.createElement(SortIcon, {
...
var HeaderContainer = function HeaderContainer(_ref) {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    style: styles.table
  }, /*#__PURE__*/react.createElement("tbody", null, /*#__PURE__*/react.createElement("tr", null, columns.map(function (column) {
  ...
  return /*#__PURE__*/react.createElement("span", {
    ...
    if (attributes) {
      ...
      for (var i = 0; i < attributes.length; i++) {
        ...
        attributeNodes.push( /*#__PURE__*/react.createElement("span", {
          key: i
        }, ' ', /*#__PURE__*/react.createElement("span", {
...
var DOMNodePreview = function DOMNodePreview(_ref3) {
  ...
  if (isCloseTag) {
    return /*#__PURE__*/react.createElement(CloseTag, {
  ...
  switch (data.nodeType) {
    case Node.ELEMENT_NODE:
      return /*#__PURE__*/react.createElement("span", null, /*#__PURE__*/react.createElement(OpenTag, {
        tagName: data.tagName,
    ...
    case Node.TEXT_NODE:
      return /*#__PURE__*/react.createElement("span", null, data.textContent);

    case Node.CDATA_SECTION_NODE:
      return /*#__PURE__*/react.createElement("span", null, '<![CDATA[' + data.textContent + ']]>');
    ...
    case Node.PROCESSING_INSTRUCTION_NODE:
      return /*#__PURE__*/react.createElement("span", null, data.nodeName);
    ...
    default:
      return /*#__PURE__*/react.createElement("span", null, nameByNodeType[data.nodeType]);
  }
};
...
var Inspector = function Inspector(_ref) {
  ...
  if (table) {
    return /*#__PURE__*/react.createElement(TableInspector$1, _extends_1({
      data: data
    }, rest));
  }

  if (isDom(data)) return /*#__PURE__*/react.createElement(DOMInspector$1, _extends_1({
    data: data
  }, rest));
  return /*#__PURE__*/react.createElement(ObjectInspector$1, _extends_1({
    data: data
  }, rest));
};
